...
unsigned short  timer0GetPrescaler(void);				///< get timer0 prescaler division rate
unsigned short  timer1GetPrescaler(void);				///< get timer1 prescaler division rate
unsigned short  timer2GetPrescaler(void);				///< get timer2 prescaler division rate
unsigned short  timer3GetPrescaler(void);				///< get timer3 prescaler division rate
...
void timer1PWMInit(unsigned char bitRes);		///< initialize and set timer1 mode to PWM
void timer1PWMInitICR(unsigned short topcount);///< initialize and set timer1 mode to PWM with specific top count
...
void timer1PWMASet(unsigned short pwmDuty);	///< set duty of timer1 Channel A (OC1A) PWM output
void timer1PWMBSet(unsigned short pwmDuty);	///< set duty of timer1 Channel B (OC1B) PWM output
void timer1PWMCSet(unsigned short pwmDuty);	///< set duty of timer1 Channel C (OC1C) PWM output

void timer3PWMInit(unsigned char bitRes);		///< initialize and set timer3 mode to PWM
void timer3PWMInitICR(unsigned short topcount);///< initialize and set timer3 mode to PWM with specific top count
...
void timer3PWMASet(unsigned short pwmDuty);	///< set duty of timer3 Channel A (OC3A) PWM output
void timer3PWMBSet(unsigned short pwmDuty);	///< set duty of timer3 Channel B (OC3B) PWM output
void timer3PWMCSet(unsigned short pwmDuty);	///< set duty of timer3 Channel C (OC3C) PWM output
